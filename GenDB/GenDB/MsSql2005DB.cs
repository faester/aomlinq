...
namespace GenDB
{
    namespace DB
    {
         ...
         */
            ...
            {
                IEntityType res = new GenEntityType();
            ...
            public IEnumerable<IPropertyType> GetAllPropertyTypes()
            {
                ...
                using (SqlConnection cnn = new SqlConnection(Configuration.ConnectStringWithDBName))
                {
                    ...
                    while (reader.Read())
                    {
                        IPropertyType tmp = new GenPropertyType();
            ...
            private Dictionary<long, IEntityType> RawEntityTypes()
            {
                ...
                using (SqlConnection cnn = new SqlConnection(Configuration.ConnectStringWithDBName))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        IEntityType et = new GenEntityType();
                        et.Name = name;
            ...
            {
                IPropertyType res = new GenPropertyType();
            ...
            {
                GenProperty res =  new GenProperty();
                ...
                using (SqlConnection cnn = new SqlConnection(Configuration.ConnectStringWithDBName))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        if (entityPOID != oldEntityPOID || firstPass)
                        {
                            ...
                            result = new GenEntity(); // We do not set EntityPOID (use NewEntity()) , since id is retrieved from DB.
                            ...
                            {
                                IPropertyValue pv = new GenPropertyValue();
                                pv.Property = prop;
        ...
        internal class GenPropertyValue : IPropertyValue
        {
        ...
        internal class GenEntityType : IEntityType
        {
            string name;
            ...
            /// GenEntityType to avoid nested look up and thus increase 
            /// performance. 
            /// </summary>
        ...
        internal class GenEntity : IEntity
        {
        ...
        internal class GenProperty : IProperty
        {
        ...
        public class GenPropertyType : IPropertyType
        {
            string name;
